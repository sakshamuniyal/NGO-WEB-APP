...
const loginAdmin = async (req, res) => {
    ...
    try {
        ...
        const token = jsonwebtoken_1.default.sign({ id: admin.id, email: admin.email, roleId: admin.roleId }, process.env.JWT_SECRET, { expiresIn: '8h' } // Token expires in 8 hours for testing
        );
