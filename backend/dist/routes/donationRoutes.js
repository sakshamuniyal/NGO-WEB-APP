...
const authMiddleware_1 = require("../middleware/authMiddleware"); // RE-IMPORT PROTECT
...
router.post('/donate', authMiddleware_1.protect, async (req, res) => {
...
router.get('/donations', authMiddleware_1.protect, async (req, res) => {
